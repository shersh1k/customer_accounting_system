...
function makeYearPhotos(photos: any, selectedYear: any) {
    let createdYear: any,
        yearPhotos: any[] = []
...
function getMorePhotos(offset: any, count: any, year: any, dispatch: any) {
...
export function getPhotos(year: any) {
    return (dispatch: any) => {
        dispatch({
