...
class Register extends React.Component<iProps, iState> {
  onSubmitRegister = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (email && password && username) this.props.onSubmitRegister(email, password, username);
  };
    ...
    return (
      <Paper>
        <form onSubmit={this.onSubmitRegister}>
          ...
          <TextField required name='username' type='text' label='Name' margin='dense' onChange={this.handleInput} />
          <TextField
            required
            name='password'
            type='password'
